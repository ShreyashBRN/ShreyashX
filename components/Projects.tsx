...
//       },
//       {
//         // Trigger when a card's row crosses the vertical center of the screen
...
//   return (
//     <section id="projects" className="w-full bg-[#f6f4ef] py-16 lg:py-24">
//       <Container>
//         <h2 className="font-bricolage text-[32px] sm:text-[36px] lg:text-[48px] font-extrabold text-[#111111] tracking-[-0.03em]">
//           Projects.
//         </h2>
//         <p className="mt-3 max-w-[560px] text-[15px] sm:text-[17px] text-[#4a4a4a] leading-[1.7]">
//           Selected work across websites, landing pages, and mobile apps.
//           Scroll the gallery to explore each build.
//         </p>

//         {/* ===== MOBILE: single-column sticky card stack (default, hidden at lg) ===== */}
...
//             >
//               <article className="mb-6 bg-white rounded-[24px] border border-black/[.06] shadow-[0_18px_50px_rgba(0,0,0,0.08)] overflow-hidden">
...
//                 </div>
//                 <div className="p-6">
//                   <span className="text-[13px] font-semibold text-[#0d7d86] uppercase tracking-wide">
//                     {project.category}
//                   </span>
//                   <h3 className="mt-2 text-[20px] font-bold text-[#111111]">
//                     {project.title}
//                   </h3>
//                   <p className="mt-2 text-[14px] text-[#4a4a4a] leading-[1.6]">
//                     {project.description}
//                   </p>
...
//                       <span
//                         key={tag}
//                         className="text-[12px] font-medium text-[#4a4a4a] bg-[#f6f4ef] border border-[#e0e0e0] rounded-full px-3 py-1"
//                       >
//                         {tag}
//                       </span>
//                     ))}
...
//                         className="text-[14px] font-semibold text-white bg-[#111111] rounded-full px-4 py-2 transition-colors duration-250 hover:bg-[#222222]"
//                       >
//                         {link.label}
//                       </Link>
//                     ))}
...
//         {/* ===== DESKTOP: split layout — left synced text, right sticky image stack ===== */}
//         <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:mt-16">
//           {/* LEFT: synced content, updates as you scroll through the right stack */}
//           <div className="sticky top-32 h-fit self-start">
//             <span className="text-[13px] font-semibold text-[#0d7d86] uppercase tracking-wide transition-opacity duration-300">
//               {activeProject.category}
//             </span>
//             <h3 className="mt-3 text-[36px] font-bold text-[#111111] transition-opacity duration-300">
//               {activeProject.title}
//             </h3>
//             <p className="mt-4 max-w-[440px] text-[17px] text-[#4a4a4a] leading-[1.7] transition-opacity duration-300">
...
//                 <span
//                   key={tag}
//                   className="text-[13px] font-medium text-[#4a4a4a] bg-white border border-[#e0e0e0] rounded-full px-3 py-1"
//                 >
//                   {tag}
//                 </span>
//               ))}
...
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="text-[15px] font-semibold text-white bg-[#111111] rounded-full px-5 py-3 transition-colors duration-250 hover:bg-[#222222]"
//                 >
//                   {link.label}
//                 </Link>
//               ))}
...
//             {/* Progress dots — optional, helps show position in the stack */}
...
//           {/* RIGHT: sticky image-only card stack */}
...
//                   style={{ top: `${112 + i * 28}px`, zIndex: i + 1 }}
//                 >
//                   <div className="relative w-full h-[440px] rounded-[24px] overflow-hidden border border-black/[.06] shadow-[0_18px_50px_rgba(0,0,0,0.08)]">
//                     <Image
//                       src={project.image}
//                       alt={project.title}
//                       fill
