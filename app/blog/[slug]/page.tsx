...
export default async function BlogPostPage({
  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-[#f6f4ef] pt-14 flex flex-col justify-between">
      <Navbar />
      <section className="w-full bg-[#f6f4ef] pt-8 pb-16 lg:pt-14 lg:pb-24 flex-1">
        <Container>
